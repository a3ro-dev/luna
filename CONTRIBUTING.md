...
Luna is a soft, supportive menstrual cycle companion built with Next.js 15, Neon Postgres, and the Vercel AI SDK. Whether you're fixing a bug, adding a feature, improving docs, or suggesting ideas — we're glad to have you.
...
**Important**: Never modify migration SQL files after they've been committed — create a new migration instead.
...
Email templates are in `src/lib/email/index.ts`:
