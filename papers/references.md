...
| Landing moon | [MoonHero.tsx](../src/components/moon/MoonHero.tsx), [MoonScene.tsx](../src/components/moon/MoonScene.tsx) | Decorative landing visual (procedural WebGL moon, scroll-driven phase). It shows no user data and makes no forecast claim. |
